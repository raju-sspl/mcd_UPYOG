...
```bash
npm install --save @mcd89/finance-ui-react-components
```
...
```json
"@mcd89/finance-ui-react-components":"1.5.24",
```
...
import MyComponent from "@mcd89/finance-ui-react-components";
...
```jsx
    import { InboxSearchComposer } from "@mcd89/finance-ui-react-components";
...
```jsx
    import { FormComposerV2 as FormComposer } from "@mcd89/finance-ui-react-components";
